...
const Profile = () => {
  ...
  const validationSchema = Yup.object({
    name: Yup.string().required("Ingrese un nuevo nombre"),
    last_name: Yup.string().required("Ingrese un nuevo apellido"),
    dni: Yup.number()
      .min(10000000)
      .max(99999999)
      .required("Ingrese un nuevo DNI"),
    phone_number: Yup.number()
      .min(100000000)
      .max(9999999999)
      .integer()
      .required("Ingrese un nuevo número de teléfono"),
  });
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <div className="flex gap-4">
              ...
              <span>{formik.touched.name ? formik.errors.name : null}</span>
