        ...
        <table className="table w-full bg-transparent sm:mt-2 sm:ml-2 table-zebra">
          <thead >
            <tr className="flex xs:justify-between xs:w-[95%]  gap-2 ">
              <th className="text-base xs:text-xs lg:text-sm xs:w-10 xs:p-0 md:p-2 xs:hidden md:block md:w-32 xl:ml-20 ">Nombre</th>
              <th className="text-base xs:text-xs lg:text-sm xs:p-0 md:p-2 xs:hidden md:block md:w-32">Email</th>
              <th className="text-base xs:text-xs lg:text-sm xs:p-0 md:p-2 xs:hidden md:block md:w-32">Direccion</th>
              <th className="text-base xs:text-xs lg:text-sm xs:p-0 md:p-2 xs:hidden md:block">Telefono</th>
              <th className="text-base xs:text-xs lg:text-sm xs:p-0 md:p-2 xs:block md:hidden">Contacto</th>
              <th className="text-base xs:text-xs lg:text-sm xs:p-0 md:p-2">Rango</th>
            ...
            {users?.map((u) => {
              return (
                <tr className="flex items-center w-[98%] md:w-[98%] gap-2 xs:justify-between ">
                  ...
                  <td className="flex-wrap text-xs lg:text-sm xs:hidden md:block md:p-0 md:w-40">{u.email}</td>
                  ...
                  <td className="xs:p-1 xs:w-24 xs:max-w-24 xs:block md:hidden" > {/*CONTACTO*/}
                    <div className="flex flex-wrap xs:text-[10px] xs:w-24 ">
                      <p className="flex flex-wrap text-xs font-bold text-primary"> {u.name} {u.last_name}</p>
